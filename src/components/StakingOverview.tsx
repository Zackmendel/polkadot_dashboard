  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          <h2 id="staking-heading" className="text-2xl font-semibold text-foreground">
            Staking overview
          </h2>
          <p id="staking-description" className="mt-1 text-sm text-foreground-muted">
      ...
      <div className="mt-6 space-y-4" aria-live="polite">
        {loading ? (
          ...
          <p className="text-sm text-foreground-muted">No staking data found for this address.</p>
        ) : (
